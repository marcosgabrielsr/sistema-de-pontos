...
class App_Add_Atestado(Func_planilhas):
    # Método construtor
    ...
    def screen_alt(self):
        self.window_alt.title("Adicionar atestado")
    ...
    def widgets_window_alt(self):
        ...
        # Botão de confirmar
        self.btn_alt = Button(self.window_alt, text="Adicionar atestado", bd=2, bg='#6095C9', fg='white', font=('verdana',12,'bold'), command=self.definir_falta_atestado)
        self.btn_alt.place(relx=0.5, rely=0.89, anchor='center')
    
    # Verifica se a planilha existe e insere o atestado na planilha
    def definir_falta_atestado(self):
